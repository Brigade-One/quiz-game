  ...
  <div style="display: flex;">
    ...
    <div style="flex: 5" id="second-block">
      <div id="home" style="display:flex">
        <div style="flex:9">
          <p><b>Quiz</b><br>
            <span id="undertext">Reviewving a question below</span>
          </p>
        </div>
      ...
      <div id="answer_options">
        <p>
          <span style="font-size:17px;"><b>Your answer</b></span>
        <form>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        if (localStorage.getItem("user_answer" + <?php echo json_encode($_GET["questionNumber"]); ?>) == localStorage.getItem("answer" + <?php echo json_encode($_GET["questionNumber"]); ?>)) {
          $("#right_answer").html("Your answer is correct");
          $("#right_answer").css("color", "green");
                }else{
        $("#right_answer").html("Your answer is incorrect. Correct answer is: " + localStorage.getItem("answer" + <?php echo json_encode($_GET["questionNumber"]); ?>));
        $("#right_answer").css("color", "red");}
      });
      ...
      function previous_question() {
        if (parseInt(questionNumber) > 1) {
          ...
          location.href = 'http://quiz-game/client/pages/check_questions.php?packageID=' + PackageID + "&questionNumber=" + previousNumber + "&questionCount=" + questionCount;
        }
      }
      ...
      function next_question() {
        ...
        if (parseInt(questionNumber) < questionCount) {
          ...
          location.href = 'http://quiz-game/client/pages/check_questions.php?packageID=' + PackageID + "&questionNumber=" + nextNumber + "&questionCount=" + questionCount;
        } else {
