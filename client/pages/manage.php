        ...
        <div class="question_info">
          ...
          <div style="display:flex">
            <div style="flex:49.5;width:10%;">
              <input type="text" class="answer_value" id="ans1" placeholder="Enter answer" required></input><span> </span><input type="text"
                placeholder="Enter hint" id="hint1" class="hint_value"></input>
            </div>
            <div style="flex:50.5;">
            </div>
          </div>
