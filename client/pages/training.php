...
<head>
    ...
    <script>
        let id = <?php echo $_GET['packageID']; ?>;
        ...
        <div style="flex: 5;" id="second-block">
            ...
            <div id="question"><label for="question_text">Change questions</label>
                <div class="question_info">
                    ...
                    <input type="text" class="question_text_value" id="text1" placeholder="Enter question text"
                        required></input>
                    <div style="display:flex">
                        <div style="flex:49.5;width:10%;">
                            <input type="text" class="answer_value" id="ans1" placeholder="Enter answer"
                                required></input><span>
