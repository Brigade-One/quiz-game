...
class CompetitionPackageQuestionLinkRepository
{
    ...
    {
        $query = "SELECT * from  CompPackageQuestionLink";
        try {
    ...
    public function fetchQuestionsByPackageID(string $packageID): array
    {
        ...
        $query = " SELECT * FROM CompPackageQuestionLink  WHERE packageID = :packageID";
    ...
    {
        $query = "SELECT * from  CompPackageQuestionLink WHERE linkID = :linkID";
        $parameters = [
            ':linkID' => $id
        ];
        try {
    ...
    public function create(PackageQuestionLink $link): bool
    {
        ...
        $query = "INSERT INTO CompPackageQuestionLink (linkID, packageID, questionID) VALUES (:linkID, :packageID, :questionID)";
        $parameters = [
    ...
    {
        $query = "UPDATE CompPackageQuestionLink SET packageID = :packageID, questionID = :questionID WHERE linkID = :linkID";
        $parameters = [
    ...
    {
        $query = "DELETE FROM CompPackageQuestionLink WHERE linkID = :linkID";
        $parameters = [
            ':linkID' => $link->getLinkID()
        ];
    ...
    {
        $query = "SELECT * from  CompPackageQuestionLink WHERE packageID = :packageID AND questionID = :questionID";
        $parameters = [
            ':packageID' => $packageID,
